...
export class Backend implements backendInterface {
    ...
    async debugGetIsAdmin(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.debugGetIsAdmin();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitReservation(arg0: SubmitReservationRequest): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitReservation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
